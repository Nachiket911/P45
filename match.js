class Match{
    ...
    constructor(){
        ...
        this.CrImage = loadImage("chromium.jpg");class Match{
    ...
    constructor(){
        ...
        this.CsSymbImage = loadImage("images/cesium.png");
        this.CsImage = loadImage("images/cesiumText.jpg");
        this.ZnSymbImage = loadImage("images/zinc.png");
        this.ZnImage = loadImage("images/zinc.jpg");
        this.CoSymbImage = loadImage("images/cobalt.png");
        this.CoImage = loadImage("images/cobalt.png");
        this.CrSymbImage = loadImage("images/chromium.png");
        this.CrImage = loadImage("images/chromium.jpg");
        this.SnSymbImage = loadImage("images/tin.png");
        this.SnImage = loadImage("images/tin.jpg");
        this.OSymbImage = loadImage("images/oxygen.png");
        this.OImage = loadImage("images/oxygenText.png");
